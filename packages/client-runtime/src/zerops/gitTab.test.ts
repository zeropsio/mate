...
import { changeState, flowPullRequest } from "./projectFlow.ts";
  ...
  function surfaces(reads: ReadonlyArray<Read>, checks: ReadonlyArray<GiteaCommitStatus>) {
    ...
    let seen:
      | {
          ...
          readonly banner: ReturnType<typeof mateReviewOffer>;
    ...
    for (const read of reads) {
      ...
      seen = {
        ...
        banner: mateReviewOffer({ pullRequests: [flow], mateProjectId: "p1", mateName: "Iris" }),
