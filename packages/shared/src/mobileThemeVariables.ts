...
export function createMobileThemeVariables(
  ...
  return {
    ...
    "--color-composer-panel": withAlpha(c.surface, appearance === "dark" ? 0.92 : 0.88),
    "--color-composer-surface": withAlpha(c.surfaceRaised, appearance === "dark" ? 0.9 : 0.94),
    "--color-composer-border": withAlpha(c.border, appearance === "dark" ? 0.46 : 0.54),
...
export const MOBILE_THEME_VARIABLE_NAMES = Object.keys(
  createMobileThemeVariables(ZEROPS_THEME.colors, "light"),
