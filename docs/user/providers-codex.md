...
If you do not want to answer, dismiss the question from its panel. Dismissing closes it
without sending anything to Codex. This works in the web, desktop, and mobile apps. Codex must support async questions.
