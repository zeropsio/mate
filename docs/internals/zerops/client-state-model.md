...
| Birth record                                                                                                                                           | `cr/zerops/birth/birthStore.ts` and one account worker (`birthWorker.ts`)             | Its own project read directly, activity, container facts, the registry   | Account, persisted           |
...
| Forge store with its scheduler                                                                    | Live                                                                                   |
...
| Dependency rule 6, construction (post-grant modules built only by `accountRuntime.ts`)            | Live; zone test "rule 6"; the web's Gitea sessions a named exception                   |
