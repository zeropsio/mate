      ...
      <SettingsSection title="General">
        ...
        <SettingsRow
          ...
          control={
            ...
            >
              <SelectTrigger className="w-full sm:w-auto sm:min-w-40" aria-label="Send shortcut">
                <SelectValue>
                  {
        ...
        <SettingsRow
          ...
          control={
            <>
              ...
              >
                <SelectTrigger className="w-full sm:w-56" aria-label="Response streaming">
                  <SelectValue>
                    ...
                    ? {
                        onOpenProviderSetup: (instanceId: ProviderInstanceId) => {
                          void navigate({
                            ...
                            search: { environmentId: primaryEnvironmentId, instanceId },
                          });
                        },
                      }
                    : {})}
