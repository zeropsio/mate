...
interface ProviderModelsSectionProps {
  ...
  /**
   * The persisted custom-model entries for this instance. Drives dedup,
   * and is the array we hand back (with an entry appended, edited, or
                      ...
                      <TooltipTrigger
                        render={
                          <Button
                            ...
                            aria-expanded={editingSlug === model.slug}
                            onClick={() =>
