    ...
    execute: (row) =>
      sql`
        INSERT INTO projection_threads (
          ...
          latest_user_message_preview_json,
        ...
        VALUES (
          ...
          ${row.latestUserMessagePreview === undefined || row.latestUserMessagePreview === null ? null : JSON.stringify(row.latestUserMessagePreview)},
        ...
        DO UPDATE SET
          ...
          latest_user_message_preview_json = excluded.latest_user_message_preview_json,
