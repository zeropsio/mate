...
describe("OrchestrationReactor", () => {
  ...
  it("starts provider ingestion, provider command, checkpoint, thread deletion, and usage pause reactors", async () => {
    ...
    runtime = ManagedRuntime.make(
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(ThreadUsagePauseReactor, {
            start: () => {
              started.push("thread-usage-pause-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
